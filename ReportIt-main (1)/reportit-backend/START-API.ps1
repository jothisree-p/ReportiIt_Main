# User-management only (port 8082) - keep this window open until Tomcat starts.
...
$env:REPORTIT_MAIL_HOST = "smtp.gmail.com"
$env:REPORTIT_MAIL_PORT = "587"
$env:REPORTIT_MAIL_USERNAME = "reportit.noreply@gmail.com"
$env:REPORTIT_MAIL_FROM = "reportit.noreply@gmail.com"
$env:REPORTIT_CONTACT_TO = "reportit.noreply@gmail.com"
...
Write-Host "Stopping old user-management-service or anything listening on port 8082..." -ForegroundColor Yellow
$apiProcesses = Get-CimInstance Win32_Process -Filter "Name = 'java.exe'" -ErrorAction SilentlyContinue |
    Where-Object { $_.CommandLine -like "*user-management-service*" } |
    Select-Object -ExpandProperty ProcessId

$portProcesses = @()
try {
    $portProcesses = Get-NetTCPConnection -LocalPort 8082 -State Listen -ErrorAction SilentlyContinue |
        Select-Object -ExpandProperty OwningProcess -Unique
} catch {
    $portProcesses = @()
}

@($apiProcesses + $portProcesses) |
    Where-Object { $_ } |
